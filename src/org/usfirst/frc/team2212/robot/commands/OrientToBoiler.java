...
public class OrientToBoiler extends CommandGroup {
    public static final Supplier<Double> BOILER_CAMERA_ID = ConstantHandler.addConstantDouble("OrientToBoiler-CAMERA_ID", 0);

    public OrientToBoiler(Supplier<Double> turningSpeed) {
        addSequential(new RunnableCommand(() -> ImageProcessingConstants.NETWORK_TABLE.putNumber("currentCamera", BOILER_CAMERA_ID.get())));
